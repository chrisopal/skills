...
- Include change management, training, governance cadence, and KPI review loops when the task touches organization design.
- Favor plans that show visible wins early to build sponsorship.

# Quality bar

Before finalizing, check that the answer:
- connects business intent to architecture and execution
- makes assumptions visible
- avoids buzzword-heavy fluff
- gives concrete structure instead of abstract inspiration
- includes risks and trade-offs
- ends with a recommendation or next-step plan

# Compression rule

If the user asks for a short answer, compress the output while preserving this logic:
**problem -> outcome -> option/recommendation -> next step**.

# Default response pattern

Unless the user requests another format, aim for this order:
1. concise framing
2. key analysis
3. recommended solution or direction
4. roadmap / action plan
5. risks / assumptions

# Examples of good requests for this skill

- Design an AI roadmap for a manufacturing group.
- Turn this smart factory idea into a proposal for management.
- Help me define the architecture and business case for an industrial AI platform.
- Evaluate whether we should build, buy, or hybridize this workflow automation solution.
- Convert this innovation idea into a phased execution plan with KPIs.
- Write an executive memo that links digitalization priorities to measurable outcomes.
