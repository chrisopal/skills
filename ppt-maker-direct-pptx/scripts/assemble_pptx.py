...
def assemble_from_specs(slide_specs_path: Path, master_style_path: Path, output_path: Path) -> Path:
    ...
    return render_ppt_from_specs(slide_specs, master_style, output_path)
