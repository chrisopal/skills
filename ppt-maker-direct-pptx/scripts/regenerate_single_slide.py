...
from run_ppt_job import compile_slide_prompt, load_json, normalize_selected_template, resolve_output_dir, write_json
...
def main() -> int:
    ...
    render_ppt_from_specs(slide_specs, master_style, output_dir / pptx_name)
