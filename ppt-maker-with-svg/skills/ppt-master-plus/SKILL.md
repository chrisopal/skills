...
- A selected Huixin Deck is a theme and narrative system, not a fixed page
  ...
  background/chrome rhythm, typography, color semantics, and narrative logic.
- Plus-only Huixin workspaces, aliases, and selector rules must survive future
  upstream syncs. Do not replace the package wholesale without reapplying this
  overlay.
