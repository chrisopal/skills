...
```bash
python3 skills/ppt-master-plus/scripts/image_gen.py \
    --manifest skills/ppt-master-plus/references/ai-image-comparison/rendering/_manifest.json \
    -o skills/ppt-master-plus/references/ai-image-comparison/rendering/ \
    --backend openai

python3 skills/ppt-master-plus/scripts/image_gen.py \
    --manifest skills/ppt-master-plus/references/ai-image-comparison/palette/_manifest.json \
    -o skills/ppt-master-plus/references/ai-image-comparison/palette/ \
    --backend openai

python3 skills/ppt-master-plus/scripts/image_gen.py \
    --manifest skills/ppt-master-plus/references/ai-image-comparison/type/_manifest.json \
    -o skills/ppt-master-plus/references/ai-image-comparison/type/ \
    --backend openai
```
