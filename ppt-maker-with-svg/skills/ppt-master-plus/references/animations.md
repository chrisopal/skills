...
python3 skills/ppt-master-plus/scripts/animation_config.py list-groups <project>
...
- Run `python3 skills/ppt-master-plus/scripts/pptx_animations.py --describe
...
python3 skills/ppt-master-plus/scripts/svg_to_pptx.py <project> -t none --auto-advance 5
```
...
```bash
python3 skills/ppt-master-plus/scripts/pptx_animations.py --list
```
