...
- **Workspace root**: `library` (default) → `skills/ppt-master-plus/templates/<kind_dir>/<template_name>/`; `project` → the confirmed `<target_project>/`
...
|---|---|
| `library` | `skills/ppt-master-plus/templates/<kind_dir>/<template_name>/` |
