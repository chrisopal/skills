...
~~~bash
python3 skills/ppt-master-plus/scripts/pptx_animations.py --describe-transition page_curl
python3 skills/ppt-master-plus/scripts/pptx_animations.py --describe-transition diamond
~~~
