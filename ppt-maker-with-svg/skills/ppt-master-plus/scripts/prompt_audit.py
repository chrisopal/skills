...
Examples:
    python3 skills/ppt-master-plus/scripts/prompt_audit.py
    python3 skills/ppt-master-plus/scripts/prompt_audit.py --json | python3 -m json.tool
...
def audit_schema_grammars(
    ...
    for config in configs:
        ...
        scan_patterns = config.get("scan", ["skills/ppt-master-plus/**/*.md"])
        accepted_by_field = {
