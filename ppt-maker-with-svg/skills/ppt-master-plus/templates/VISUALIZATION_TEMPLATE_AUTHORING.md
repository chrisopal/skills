...
```bash
# 单文件 SVG 合同
python3 skills/ppt-master-plus/scripts/svg_quality_checker.py \
  skills/ppt-master-plus/templates/<family-directory>/<key>.svg
...
python3 skills/ppt-master-plus/scripts/compact_svg_coordinates.py \
  skills/ppt-master-plus/templates/<family-directory>/<key>.svg
```
