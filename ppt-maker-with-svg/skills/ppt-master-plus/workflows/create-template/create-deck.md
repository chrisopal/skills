...
```bash
python3 skills/ppt-master-plus/scripts/register_template.py <deck_id> --kind deck --dry-run
python3 skills/ppt-master-plus/scripts/register_template.py <deck_id> --kind deck
```
