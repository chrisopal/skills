...
```bash
python3 skills/ppt-master-plus/scripts/register_template.py <layout_id> --kind layout --dry-run
python3 skills/ppt-master-plus/scripts/register_template.py <layout_id> --kind layout
```
