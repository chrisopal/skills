...
```bash
python3 skills/ppt-master-plus/scripts/svg_quality_checker.py <project_path> --stage final --json
...
Run
`python3 skills/ppt-master-plus/scripts/pptx_animations.py --describe-transition <effect>`
...
`python3 skills/ppt-master-plus/scripts/pptx_animations.py --list` for the exact
...
`python3 skills/ppt-master-plus/scripts/pptx_animations.py --describe
...
```bash
python3 skills/ppt-master-plus/scripts/video_motion_plan.py \
